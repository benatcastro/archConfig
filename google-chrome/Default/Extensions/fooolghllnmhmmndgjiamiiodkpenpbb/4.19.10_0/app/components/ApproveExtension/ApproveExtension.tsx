...
const ApproveExtension: FC = () => {
  ...
  useEffect(() => {
    ...
    return createListener('ApproveExtension', handleApproveCodeChange, ListenerType.StorageChange);
  }, [isMountedRef]);
  ...
  return (
    <div className="flex flex-col justify-center items-center text-grey-darkest leading-normal text-small font-medium h-screen bg-primary">
      <div className="text-lead font-bold mb-6 text-center max-w-500 color-primary">
...
export default ApproveExtension;
