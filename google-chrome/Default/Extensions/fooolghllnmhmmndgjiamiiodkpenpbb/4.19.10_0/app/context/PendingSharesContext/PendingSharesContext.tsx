...
const PendingSharesContext = createContext([]);

export const PendingSharesProvider: FC = ({ children }) => {
  const [shares, setShares] = useState<Array<IItem>>([]);
  const [newPendingShares, setNewPendingShares] = useState([]);
...
export default PendingSharesContext;
